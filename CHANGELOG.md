...
## [Unreleased]
## [1.0.0] - 2025-01-24 (View History Functionality update and Final Full release)

### Added
- Button in /appointments page to navigate to history

### Changed
- User will be able to navigate and view appointments history

### Fixed
- **Appointment History Functionality**: Implemented missing Appoitment history functionality which was taking a hardcoded appointment list
